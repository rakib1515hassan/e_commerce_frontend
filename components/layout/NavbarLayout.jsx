...
const Navbar = () => {
  ...
  return (
    <header className="w-full shadow-md">
      {/* Top Bar */}
      {/* Top Bar */}
      <div className="flex justify-between items-center w-full bg-gray-100 h-[40px]">
        {/* Order Message */}
        <div className="text-center text-xs sm:text-sm py-1 flex-1">
          Order Before 17:30, Shipped Today
        </div>

        {/* Account & Cart */}
        <div className="hidden md:flex items-center space-x-4 text-gray-700 me-7">
      ...
      <div className="bg-white flex justify-between items-center px-4 sm:px-6 py-3">
        ...
        <div className="hidden md:flex items-center space-x-4 text-gray-700">
          <div className="flex items-center cursor-pointer me-8">
            <FaShoppingBasket size={40} />
            <div className="flex flex-col ms-4">
               <span className="text-black-600 font-bold">Shopping Cart</span>
      ...
      {/* Dropdown Menu */}
      {menuOpen && (
        <div className="absolute bg-white w-64 shadow-md left-4 sm:left-6 top-40 z-10 border rounded-md">
          <ul className="py-2">
